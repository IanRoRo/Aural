...
from intel_ligencia_pro import ( 
...
# =====================================================================
FITXER_SESSIO = ruta_dades_usuari("session_state_pro.json")
...
# =====================================================================
# VERIFICACIÓ I INSTAL·LACIÓ AUTOMÀTICA DE DEPENDÈNCIES
# =====================================================================
def verificar_i_instal·lar_deepseek():
    print("\n" + "=" * 60)
    print("🔍 VERIFICANT DEPENDÈNCIES D'AURAL PRO")
    print("=" * 60)
    ...
    print("\n[2/2] Verificant model DeepSeek-R1:8b...")
    try:
        result = subprocess.run(
            ["ollama", "list"],
            capture_output=True,
        ...
        if "deepseek-r1:8b" in models_disponibles or "deepseek-r1" in models_disponibles:
            print("✅ Model DeepSeek-R1:8b detectat")
        else:
            print("⚠️ Model DeepSeek-R1:8b no trobat")
            print("\n📥 Descarregant DeepSeek-R1:8b (això pot trigar uns minuts)...")
            print("   Mida aproximada: ~5GB")
            try:
                ...
                if proc.returncode == 0:
                    print("\n✅ Model DeepSeek-R1:8b descarregat correctament!")
                else:
                    print("\n❌ Error descarregant el model")
                    print("   Intenta executar manualment: ollama pull deepseek-r1:8b")
                    sys.exit(1)
            except Exception as e:
...
def guardar_a_csv(dades, estat, missatge_ia):
    ...
    try:
        ...
        print(f"[ERROR CSV PRO]: {e}")

# =====================================================================
# ESTAT GLOBAL DE LA SESSIÓ
# =====================================================================
ESTAT_SESSIO = {
    "objectiu": "",
    "categoria": "",
...
def main():
    ...
    verificar_i_instal·lar_deepseek()
    print("\n" + "=" * 60)
    print("🚀 AURAL PRO - Versió amb DeepSeek-R1 (8B)")
    print("=" * 60)
    ...
    print(f"\n[SISTEMA AURAL PRO] Sessió iniciada.")
    ...
    def _neteja_final():
        try:
            ...
            print("\n💾 Sessió PRO guardada per si vols reprendre-la.")
        except Exception as e:
    ...
    def _handler_sigint(sig, frame):
        print("\n[!] Interrupció detectada. Guardant sessió PRO...")
        _neteja_final()
        sys.exit(0)
        ...
        while True:
            try:
                ...
                if mode_actual == "RECONEIXEMENT":
                    if (
                        ...
                        if PREGUNTAR_SEGUENT_PAS() == "TREBALLAR":
                            ...
                            MOSTRAR_FINESTRA_OK(
                                f"🛡️ Escut Guardià PRO activat per a {categoria.upper()}!"
                            )
                    else:
                        print(
                ...
                if nom_app in cat_data["llista_blanca"]:
                    ...
                    print(
                        f"\n🧠 [PRO] App desconeguda '{nom_app}': la IA suggereix {estat_ia}."
                    )
                ...
                if estat == "PRODUCTIU":
                    ...
                    print(f"\n[DISTRACTE PRO] Avís crític: {comptador_avisos}/3")
                ...
                print(
                    f"\r[PRO] FELI: [{barra}] | Avisos: {comptador_avisos}/3 | "
                ...
                print(f"\n[ERROR CRÍTIC BUCLE PRO]: {e}")
                time.sleep(2)

    except KeyboardInterrupt:
        print("\n[!] Interrupció manual. Guardant sessió PRO...")
    finally:
        try:
            _neteja_final()
        except Exception:
